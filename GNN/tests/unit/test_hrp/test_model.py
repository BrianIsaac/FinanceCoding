...
class TestHRPModel:
    ...
    def test_fit_insufficient_asset_coverage(self, hrp_model, sample_returns_data):
        ...
        universe = sample_returns_data.columns.tolist() + ['MISSING_1', 'MISSING_2', 'MISSING_3', 'MISSING_4', 'MISSING_5']
        fit_period = (
            pd.Timestamp('2020-06-01'),
            pd.Timestamp('2021-06-01')
        )
    ...
    def test_predict_weights_single_asset(self, hrp_model, sample_returns_data):
        ...
        single_asset_weights = hrp_model.predict_weights(
            pd.Timestamp('2021-07-01'),
            [universe[0]]
        )
    ...
    def test_get_model_info(self, hrp_model, sample_returns_data):
        ...
        assert info_unfitted["is_fitted"] == False
        ...
        assert info_fitted["is_fitted"] == True
    ...
    def test_risk_contributions(self, hrp_model, sample_returns_data):
        ...
        risk_contributions = hrp_model.get_risk_contributions(
            weights,
            pd.Timestamp('2021-07-01')
        )
