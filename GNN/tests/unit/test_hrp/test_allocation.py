...
class TestHRPAllocation:
    ...
    def sample_cluster_tree(self):
        ...
        return {
            ...
            "left": {
                ...
                "assets": ["A", "B", "C"],
                "distance": 0.3,
                "left": {"id": 0, "type": "leaf", "asset": "A", "assets": ["A"], "distance": 0.0},
                "right": {
                    "id": 5,
                    "type": "cluster",
                    "assets": ["B", "C"],
            ...
            "right": {
                ...
                "assets": ["D", "E"],
                "distance": 0.4,
                "left": {"id": 3, "type": "leaf", "asset": "D", "assets": ["D"], "distance": 0.0},
                "right": {"id": 4, "type": "leaf", "asset": "E", "assets": ["E"], "distance": 0.0},
            },
        }
    ...
    def test_allocation_initialization(self):
        ...
        config = AllocationConfig(
            risk_measure="vol", min_allocation=0.005, max_allocation=0.15, allocation_precision=4
        )
    ...
    def test_recursive_bisection_basic(
        self, allocation_engine, sample_covariance_matrix, sample_cluster_tree
    ):
        """Test basic recursive bisection functionality."""
        weights = allocation_engine.recursive_bisection(
            sample_covariance_matrix, sample_cluster_tree
        )
    ...
    def test_single_asset_cluster(self, allocation_engine):
        ...
        weights = allocation_engine.recursive_bisection(single_asset_cov, single_asset_tree)
    ...
    def test_allocation_constraints(self, allocation_engine, sample_covariance_matrix):
        ...
        raw_weights = pd.Series([0.8, 0.15, 0.03, 0.015, 0.005], index=["A", "B", "C", "D", "E"])
    ...
    def test_risk_budgeting_calculation(
        self, allocation_engine, sample_covariance_matrix, sample_cluster_tree
    ):
        ...
        risk_contributions = allocation_engine.calculate_risk_budgets(
            weights, sample_covariance_matrix, sample_cluster_tree
        )
        ...
        np.sqrt(np.dot(weights.values, np.dot(sample_covariance_matrix.values, weights.values)))
    ...
    def test_optimize_cluster_allocation(self, allocation_engine, sample_covariance_matrix):
        ...
        optimized_weights = allocation_engine.optimize_cluster_allocation(
            cluster_assets, sample_covariance_matrix, target_allocation
        )
        ...
        single_optimized = allocation_engine.optimize_cluster_allocation(
            ["A"], sample_covariance_matrix, target_allocation
        )
    ...
    def test_edge_case_handling(
        ...
        needs_handling, handling_type = allocation_engine.handle_edge_cases(
            sample_cluster_tree, sample_covariance_matrix
        )
        ...
        needs_handling, handling_type = allocation_engine.handle_edge_cases(
            single_asset_tree, sample_covariance_matrix
        )
        ...
        empty_tree = {"id": 0, "type": "cluster", "assets": [], "distance": 0.0}

        needs_handling, handling_type = allocation_engine.handle_edge_cases(
            empty_tree, sample_covariance_matrix
        )
    ...
    def test_covariance_matrix_alignment(self, allocation_engine):
        ...
        cov_matrix = pd.DataFrame(
            np.eye(5) * 0.01, index=["A", "B", "C", "X", "Y"], columns=["A", "B", "C", "X", "Y"]
        )
