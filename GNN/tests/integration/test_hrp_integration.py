...
class TestHRPIntegration:
    ...
    def test_hrp_model_fitting_integration(self, sample_market_data, portfolio_constraints, hrp_config):
        ...
        assert model_info["is_fitted"] == True
    ...
    def test_monthly_rebalancing_simulation(self, sample_market_data, portfolio_constraints, hrp_config):
    ...
    def test_clustering_diagnostics_integration(self, sample_market_data, portfolio_constraints, hrp_config):
    ...
    def test_risk_contribution_analysis(self, sample_market_data, portfolio_constraints, hrp_config):
    ...
    def test_backtesting_integration_stub(self, sample_market_data, portfolio_constraints, hrp_config):
