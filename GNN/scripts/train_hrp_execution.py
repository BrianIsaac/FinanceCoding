...
from config.base import ProjectConfig, DataConfig, load_config
...
from utils.gpu import GPUMemoryManager, GPUConfig
...
def main():
    ...
    print("Starting HRP Model Training Execution...")
    ...
    # Print summary
    print("\n" + "="*60)
    print("HRP TRAINING EXECUTION SUMMARY")
    print("="*60)
    print(f"Status: {results['status']}")
    print(f"Execution Time: {results['execution_time']}")
    
    if results['status'] == 'success':
        print(f"Universe Size: {results['universe_size']} assets")
        print(f"Training Observations: {results['training_observations']}")
