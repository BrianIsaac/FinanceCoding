...
from src.config.base import ProjectConfig, DataConfig, load_config
...
from src.evaluation.validation.significance import PerformanceSignificanceTest, StatisticalValidation
...
class PerformanceAnalyticsExecutor:
    ...
    def execute_task_2_statistical_significance(self, returns_dict: Dict[str, pd.Series]) -> None:
        ...
        ml_keys = [k for k in returns_dict.keys() if k not in baseline_keys]
    ...
    def execute_task_5_publication_reporting(self, returns_dict: Dict[str, pd.Series]) -> None:
        ...
        for model_name in returns_dict.keys():
            ...
            model_tests = jk_results[jk_results["portfolio_a"] == model_name]
            ...
            for j, model_b in enumerate(model_names):
                if i == j:
                    ...
                    if not test_row.empty:
                        ...
                        is_significant = test_row.iloc[0]["is_significant"]
    ...
    def execute_task_6_results_validation(self, returns_dict: Dict[str, pd.Series]) -> None:
        ...
        qa_checks = {
            "data_integrity": {
                ...
                "consistent_frequencies": len(set(returns.index.freq for returns in returns_dict.values() if returns.index.freq)) <= 1
            },
...
def main(config_path: Optional[str] = None, results_dir: Optional[str] = None) -> None:
